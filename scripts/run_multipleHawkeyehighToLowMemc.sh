...
for filename in "${my_list[@]}"; do
    ...
    for nr_to_free in 6250000; do
        ...
        sudo insmod /home/gulshan/parth/misc-collection-master/HawkEye/modules/origBloat4.3/remove_multipleHawkeye/remove_multipleHawkeyehighToLow.ko pid=$integer_value pid1=$integer_value1 nr_to_free=$nr_to_free
